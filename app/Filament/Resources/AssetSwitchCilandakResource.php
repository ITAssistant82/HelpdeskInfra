...
use App\Filament\Resources\AssetSwitchCilandakResource\Pages;
...
class AssetSwitchCilandakResource extends Resource
{
    ...
    {
        $user = auth()->user();
        return $user && ($user->hasAnyRole(['super_admin', 'admin']) || $user->can('view_any_asset_switch_cilandak'));
    }
    public static function canCreate(): bool
    {
        $user = auth()->user();
        return $user && ($user->hasAnyRole(['super_admin', 'admin']) || $user->can('create_asset_switch_cilandak'));
    }
    ...
    {
        return ['index' => Pages\ListAssetSwitchCilandaks::route('/'), 'create' => Pages\CreateAssetSwitchCilandak::route('/create'), 'edit' => Pages\EditAssetSwitchCilandak::route('/{record}/edit'), ];
    }
}
