...
class TicketCategoryResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        ...
        }), ])->filters([Tables\Filters\SelectFilter::make('type')->options(['Incident' => 'Incident', 'Service Request' => 'Service Request']), Tables\Filters\SelectFilter::make('main_category')->options(fn () => TicketCategory::distinct()->pluck('main_category', 'main_category')->toArray())])->actions([Actions\EditAction::make()])->bulkActions([Actions\BulkActionGroup::make([Actions\DeleteBulkAction::make()])]);
    }
