...
class StatsOverview extends BaseWidget
{
    ...
    {
        $overdueTickets = Ticket::whereNotIn('status', ['Solved', 'Closed', 'Rejected/Out of Scope'], 'and')->where('sla_deadline', '<', now())->count('*');
        $pendingApproval = Ticket::where('status', '=', 'Pending Approval', 'and')->count('*');
