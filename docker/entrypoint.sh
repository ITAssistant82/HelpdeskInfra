...
for var in APP_NAME APP_URL APP_ENV APP_DEBUG DB_CONNECTION DB_HOST DB_PORT DB_DATABASE DB_USERNAME DB_PASSWORD MICROSOFT_REDIRECT_URI MICROSOFT_CLIENT_ID MICROSOFT_CLIENT_SECRET MICROSOFT_TENANT_ID CACHE_STORE; do
    if [ -n "${!var}" ]; then
        value="${!var}"
